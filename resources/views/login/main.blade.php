...
<head>
    ...
    <title>Login | Pengelola surat</title>
</head>
            ...
            <div class="row shadow ">
                <div class="col-lg-6 col-md-6 col-sm-12 card-none-color p-4 p-md-5 order-1 order-md-0">
                    <div class="text-center text-md-start">
                        ...
                        <h4 style="font-weight: bolder;">Di Aplikasi Pengelola surat </h4>
                        {{-- <p style="font-size: small; color: grey;">Pengelola surat adalah sebuah platform atau aplikasi yang digunakan untuk memudahkan pengguna dalam membeli,dan mengecek jadwal konsultasi. </p> --}}
                    </div>
